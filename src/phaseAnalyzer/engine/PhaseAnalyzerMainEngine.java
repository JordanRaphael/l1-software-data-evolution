...
public class PhaseAnalyzerMainEngine {
	...
	public PhaseAnalyzerMainEngine(String inputCsv, String outputAssessment1, String outputAssessment2,
			Float tmpTimeWeight, Float tmpChangeWeight, Boolean tmpPreProcessingTime, Boolean tmpPreProcessingChange) {
	...
	public void extractPhases(int numPhases) {
		...
		phaseCollector = phaseExtractor.extractAtMostKPhases(transitionHistory, numPhases, timeWeight, changeWeight,
	...
	public void parseInput() {
		...
		transitionHistory = parser.parse(inputCsv, ";");
		transitionHistory.consoleVerticalReport();
	}
