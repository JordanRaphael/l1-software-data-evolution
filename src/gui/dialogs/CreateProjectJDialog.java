...
public class CreateProjectJDialog extends JDialog {
	...
	public CreateProjectJDialog(String projectName, String datasetTxt, String inputCsv, String ass1, String ass2,
			String transXml) {
		...
		textFieldProjectName.setText(projectName);
		textFieldDatasetTxt.setText(datasetTxt);
		textFieldInputCsv.setText(inputCsv);
		textFieldAss1.setText(ass1);
		textFieldAss2.setText(ass2);
		textFieldTransXml.setText(transXml);
		...
		gl_contentPanel.setHorizontalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup()
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addComponent(lblNewLabel)
								...
								.addComponent(lblAssessementoutput).addComponent(lblNewLabel_4))
						...
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
								...
								.addComponent(textFieldInputCsv, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 242,
										Short.MAX_VALUE)
								.addComponent(textFieldAss1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 242,
										Short.MAX_VALUE)
								.addComponent(textFieldAss2, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 242,
										Short.MAX_VALUE)
								.addComponent(textFieldTransXml, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 242,
										Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_contentPanel.setVerticalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup().addContainerGap()
						.addGroup(
								gl_contentPanel.createParallelGroup(Alignment.BASELINE).addComponent(lblNewLabel)
										.addComponent(
												textFieldProjectName, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING, false)
								.addGroup(gl_contentPanel.createSequentialGroup()
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_contentPanel.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblNewLabel_1).addComponent(buttonDatasetTxt)))
								.addGroup(gl_contentPanel.createSequentialGroup()
										.addPreferredGap(ComponentPlacement.RELATED, 8, Short.MAX_VALUE)
										.addComponent(textFieldDatasetTxt, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
						.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.BASELINE).addComponent(lblNewLabel_3)
								.addComponent(textFieldAss1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(buttonAss1))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.BASELINE)
								.addComponent(textFieldAss2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblAssessementoutput).addComponent(buttonAss2))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.BASELINE)
								.addComponent(textFieldTransXml, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblNewLabel_4).addComponent(buttonTransXml))
						.addGap(18)));
