...
CREATE TABLE `t_file` (
    ...
    `waitforsources` BIT NOT NULL,
    `querymoresources` BIT NOT NULL,
    ...
    `transfersucceeded` BIT NOT NULL DEFAULT 0,
    `report`  TEXT DEFAULT NULL,
...
CREATE TABLE `t_subscription` (
    ...
    `markedincomplete` BIT NOT NULL DEFAULT 0,
    `markedcomplete` BIT NOT NULL DEFAULT 0,
    `hasdonefiles` BIT NOT NULL DEFAULT 0,
    `hasholdfiles` BIT NOT NULL DEFAULT 0,
    `hasavailablefiles` BIT NOT NULL DEFAULT 0,
